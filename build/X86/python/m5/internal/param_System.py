...
class SystemParams(m5.internal.param_MemObject.MemObjectParams):
    ...
    thermal_components = _swig_property(_param_System.SystemParams_thermal_components_get, _param_System.SystemParams_thermal_components_set)
    thermal_model = _swig_property(_param_System.SystemParams_thermal_model_get, _param_System.SystemParams_thermal_model_set)
