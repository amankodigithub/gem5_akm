...
class AtomicOpFunctor(object):
    ...
    def __call__(self, p):
        return _range.AtomicOpFunctor___call__(self, p)
    __swig_destroy__ = _range.delete_AtomicOpFunctor
    __del__ = lambda self: None
AtomicOpFunctor_swigregister = _range.AtomicOpFunctor_swigregister
