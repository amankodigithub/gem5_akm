...
class AtomicOpFunctor(object):
    ...
    def __call__(self, p):
        return _core.AtomicOpFunctor___call__(self, p)
    __swig_destroy__ = _core.delete_AtomicOpFunctor
    __del__ = lambda self: None
AtomicOpFunctor_swigregister = _core.AtomicOpFunctor_swigregister
...
def listenersDisabled():
    return _core.listenersDisabled()
listenersDisabled = _core.listenersDisabled
