...
class BaseCacheParams(m5.internal.param_MemObject.MemObjectParams):
    ...
    data_latency = _swig_property(_param_BaseCache.BaseCacheParams_data_latency_get, _param_BaseCache.BaseCacheParams_data_latency_set)
    ...
    tag_latency = _swig_property(_param_BaseCache.BaseCacheParams_tag_latency_get, _param_BaseCache.BaseCacheParams_tag_latency_set)
