...
import m5.internal.enum_ThreadPolicy
...
class MinorCPUParams(m5.internal.param_BaseCPU.BaseCPUParams):
    ...
    threadPolicy = _swig_property(_param_MinorCPU.MinorCPUParams_threadPolicy_get, _param_MinorCPU.MinorCPUParams_threadPolicy_set)
