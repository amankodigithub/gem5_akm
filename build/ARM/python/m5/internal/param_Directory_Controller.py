...
class Directory_ControllerParams(m5.internal.param_RubyController.RubyControllerParams):
    ...
    dmaRequestToDir = _swig_property(_param_Directory_Controller.Directory_ControllerParams_dmaRequestToDir_get, _param_Directory_Controller.Directory_ControllerParams_dmaRequestToDir_set)
    dmaResponseFromDir = _swig_property(_param_Directory_Controller.Directory_ControllerParams_dmaResponseFromDir_get, _param_Directory_Controller.Directory_ControllerParams_dmaResponseFromDir_set)
    forwardFromDir = _swig_property(_param_Directory_Controller.Directory_ControllerParams_forwardFromDir_get, _param_Directory_Controller.Directory_ControllerParams_forwardFromDir_set)
