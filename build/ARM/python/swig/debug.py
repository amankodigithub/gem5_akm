...
class SimpleFlag(Flag):
    ...
    def sync(self):
        return _debug.SimpleFlag_sync(self)
...
class CompoundFlag(Flag):
    ...
    def kids(self):
        return _debug.CompoundFlag_kids(self)
...
class AtomicOpFunctor(object):
    ...
    def __call__(self, p):
        return _debug.AtomicOpFunctor___call__(self, p)
...
def schedRelBreak(delta):
    return _debug.schedRelBreak(delta)
schedRelBreak = _debug.schedRelBreak

def breakAtKernelFunction(funcName):
    return _debug.breakAtKernelFunction(funcName)
